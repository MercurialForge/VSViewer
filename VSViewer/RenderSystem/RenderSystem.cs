...
namespace VSViewer.Rendering
{
    ...
    class RenderSystem : D3D11
    {
        ...
        private List<UInt16> indicesmock = new List<ushort>();
        ...
        public void Load()
        {
            for(int i = 0; i < 228; i++)
            {
                indicesmock.Add((UInt16)i);
            }

            string file = @"E:\CloudServices\GoogleDrive\VSTools\WEPs\60.WEP";
        ...
        public RenderSystem()
        {
            using (DisposeGroup dg = new DisposeGroup())
            {
                ...
                // --- init indices
                var g_pIndexBuffer = dg.Add(DXUtils.CreateBuffer(Device, indicesmock.ToArray()));
                ...
                m_textureRV = ShaderResourceView.FromFile(Device, @"C:\Users\Mercurial Forge\Desktop\My Projects\C#\VSViewer\VSViewer\bin\Debug\paletteMap0.png");
        ...
        public override void RenderScene(DrawEventArgs args)
        {
            ...
            m_device.ImmediateContext.Draw(m_skinnedVertices.Length, 0);
        }
        ...
        private void ApplySkinning()
        {
            ...
            WeaveBuffer(skinnedVertices, geometry.uv1);
        }

        private void WeaveBuffer(Vector3[] vertices, List<Vector2> uvs)
        {
